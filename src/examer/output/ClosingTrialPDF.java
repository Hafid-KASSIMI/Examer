...
import examer.output.metrics.ClosingPage;
 ...
 * @author H. KASSIMI
 */
public class ClosingTrialPDF extends BasePDFFile {

    private final ClosingPage page;
    
    public ClosingTrialPDF() {
        super();
        page = new ClosingPage();
        tpl = tempaltesDir + "closing.pdf";
    }
        ...
        bpi.forEach(bp -> {
            ...
            try {
                try (PDPageContentStream pcs = new PDPageContentStream(doc, pg, PDPageContentStream.AppendMode.APPEND, true, true)) {
                    ...
                    placeBidirectionalString(page.getDate(), pcs, bp.getDate(), ALIGNMENT.RIGHT);
                    placeBidirectionalString(page.getHour(), pcs, bp.getClosing(), ALIGNMENT.RIGHT);
                    ...
                    placeBidirectionalString(page.getSecretaryName(), pcs, Settings.PREF_BUNDLE.get("TRIAL_SECRETARY_NAME"));
                    placeBidirectionalString(page.getSecretaryNum(), pcs, Settings.PREF_BUNDLE.get("TRIAL_SECRETARY_CODE"));
